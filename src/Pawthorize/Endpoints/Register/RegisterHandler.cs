...
/// Creates new user accounts, validates email uniqueness, hashes passwords,
/// and optionally sends email verification based on configuration.
...
/// <typeparam name="TRegisterRequest">Registration request type (can be extended with additional fields)</typeparam>
