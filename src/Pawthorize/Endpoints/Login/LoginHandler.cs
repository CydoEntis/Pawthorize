...
/// <summary>
/// HTTP endpoint handler for user login (authentication).
/// Validates credentials, checks account status, handles rate limiting and lockout,
/// and returns authentication tokens via the configured delivery strategy.
/// </summary>
